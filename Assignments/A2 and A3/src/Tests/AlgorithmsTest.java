...
public class AlgorithmsTest {
    ...
    public void commonDownstreamTest() {
        // Test Normal case
        List<Vertex> intersectionList = Algorithms.commonDownStream(aGraph, a, e);
        ...
        assertEquals(0, Algorithms.commonDownStream(aGraph, l, a).size()); // "L"
                                                                           // is
                                                                           // not
                                                                           // connected
                                                                           // to
                                                                           ...
                                                                           // graph
        // Test Symmetry
        assertEquals(Algorithms.commonDownStream(aGraph, a, e).size(),
                Algorithms.commonDownStream(aGraph, e, a).size());
    }
    ...
    public void commonUpstreamTest() {
        ...
        // Test Normal case
        List<Vertex> intersectionList = Algorithms.commonUpStream(aGraph, d, e);
        ...
        // Test No commonUpstream
        assertEquals(0, Algorithms.commonUpStream(aGraph, l, a).size()); // "L"
                                                                         // is
                                                                         // not
                                                                         // connected
                                                                         // to
        ...
        // Test Symmetry
        assertEquals(Algorithms.commonUpStream(aGraph, d, e).size(), Algorithms.commonUpStream(aGraph, e, d).size());
    }
